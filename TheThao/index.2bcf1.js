...
if (!t) return null;
var a = (null == e ? void 0 : e.type) || r(t), i = {
url: t,
type: a
};
"number" == typeof (null == e ? void 0 : e.width) && (i.width = e.width);
"number" == typeof (null == e ? void 0 : e.height) && (i.height = e.height);
var c = cc.loader;
if (!c || "function" != typeof c.load) return null;
c.load(i, function(t, e) {
t ? n(t) : o(new cc.SpriteFrame(e));
});
});
};
...
switch (a.label) {
case 0:
return e ? [ 4, this.loadSpriteFrameFromUrl(e, o) ] : [ 2, null ];

case 1:
n = a.sent();
cc.isValid(t) && cc.isValid(t.node) && (t.spriteFrame = n);
return [ 2, n ];
}
});
});
...
"use strict";
cc._RF.push(e, "02e47OmuWBAiI1AIgM9qIqL", "OddData");
Object.defineProperty(o, "__esModule", {
value: !0
});
cc._RF.pop();
...
"use strict";
cc._RF.push(e, "081c3DWkJxNK7fw6QitM8mv", "TheThaoContext");
Object.defineProperty(o, "__esModule", {
value: !0
});
